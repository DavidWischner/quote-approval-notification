 ...
 */
class QuoteApprovalDeclinedMailTypeBuilderPlugin extends AbstractQuoteApprovalMailTypeBuilderPlugin
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected const MAIL_TEMPLATE_HTML = 'QuoteApprovalNotification/mail/quote_approval_declined_mail.html.twig';

    /**
     * @var string
     */
    protected const MAIL_TEMPLATE_TEXT = 'QuoteApprovalNotification/mail/quote_approval_declined_mail.text.twig';
