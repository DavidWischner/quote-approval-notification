 ...
 */
class QuoteApprovalApprovedMailTypeBuilderPlugin extends AbstractQuoteApprovalMailTypeBuilderPlugin
{
    /**
     * @var string
     */
    public const MAIL_TYPE = 'QuoteApprovalApprovedMailType';

    /**
     * @var string
     */
    protected const MAIL_TEMPLATE_HTML = 'QuoteApprovalNotification/mail/quote_approval_approved_mail.html.twig';

    /**
     * @var string
     */
    protected const MAIL_TEMPLATE_TEXT = 'QuoteApprovalNotification/mail/quote_approval_approved_mail.text.twig';

    /**
     * @var string
     */
    protected const MAIL_SUBJECT_GLOSSARY_KEY = 'mail.quote.approval.approved.subject';
    ...
    {
        return $quoteApprovalNotificationTransfer->getBuyerOrFail();
    }
}
