 ...
 */
class BuyerExpanderPlugin extends AbstractPlugin implements QuoteApprovalNotificationExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Expands QuoteApprovalNotificationTransfer with buyer information.
     *
     * @api
     *
    ...
    public function expand(
        ...
        return $this->getFacade()->expandNotificationWithBuyer(
