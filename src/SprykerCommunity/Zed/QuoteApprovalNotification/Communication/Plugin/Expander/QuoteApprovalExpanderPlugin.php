 ...
 */
class QuoteApprovalExpanderPlugin extends AbstractPlugin implements QuoteApprovalNotificationExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Expands QuoteApprovalNotificationTransfer with quote approval information.
     *
     * @api
     *
    ...
    public function expand(
        ...
        return $this->getFacade()
            ->expandNotificationWithQuoteApproval($notificationTransfer, $quoteApprovalEventTransfer);
    }
}
