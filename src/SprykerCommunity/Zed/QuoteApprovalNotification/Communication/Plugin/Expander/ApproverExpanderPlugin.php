 ...
 */
class ApproverExpanderPlugin extends AbstractPlugin implements QuoteApprovalNotificationExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Expands QuoteApprovalNotificationTransfer with approver information.
     *
     * @api
     *
    ...
    public function expand(
        ...
        return $this->getFacade()->expandNotificationWithApprover(
