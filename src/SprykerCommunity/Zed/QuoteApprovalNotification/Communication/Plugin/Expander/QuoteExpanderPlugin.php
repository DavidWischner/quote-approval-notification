 ...
 */
class QuoteExpanderPlugin extends AbstractPlugin implements QuoteApprovalNotificationExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Expands QuoteApprovalNotificationTransfer with quote information.
     *
     * @api
     *
    ...
    public function expand(
        ...
        return $this->getFacade()->expandNotificationWithQuote(
