 ...
 */
class QuoteApprovalCancelledMailTypeBuilderPlugin extends AbstractPlugin implements MailTypeBuilderPluginInterface
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected const MAIL_TEMPLATE_HTML = 'customer/mail/quote_approval_cancelled_mail.html.twig';

    /**
     * @var string
     */
    protected const MAIL_TEMPLATE_TEXT = 'customer/mail/quote_approval_cancelled_mail.text.twig';
